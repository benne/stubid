...
public sealed class StubIdBuilder : ContainerBuilder<StubIdBuilder, StubIdContainer, StubIdConfiguration>
{
    ...
    /// </remarks>
    public const string StubIdImage = "ghcr.io/benne/stubid:2026.09.3";
